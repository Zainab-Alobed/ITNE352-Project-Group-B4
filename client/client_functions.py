    ...
    try:
        ...
        while True:  # Loop until the user chooses to quit
            ...
            if main_selection == "1":
                ...
                if Headlines_selection == -1:  # Invalid input, go back to main menu
                    continue  # Return to main menu
                
                if Headlines_selection == "5":  # Back to main menu
                    continue
                elif Headlines_selection == "4":
                    request = f"{main_desc},{Headlines_desc}"  # Request for 'all'
                else:
            ...
            # Handle Sources menu
                ...
                if sources_selection == -1:  # Invalid input, go back to main menu
                    continue
                
                if sources_selection == "5":  # Back to main menu
                    continue
                    ...
                    request = f"{main_desc},{source_desc},{value}"  # Valid request for specific source criteria
